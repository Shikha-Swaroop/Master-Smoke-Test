...
public class SignUpTests extends BaseTest {
	...
	@TestRail(id = "C8538")
	@Test(enabled = true, retryAnalyzer = Retry.class, groups = { "smoke" }, priority = 1, description = "eFax > Japan > Funnel > My Account > Validate Account Registration is Successful & Login to My Account without issues")
	public void verifyNewUserSignUpLogin(ITestContext context) throws Exception {
		...
		String content = signup.getWelcomeEmail(email, "【重要】eFax Plus へようこそ／本人確認及び拠点確認書類提出のお願い[eFax]", 60);
		logger.info(content);

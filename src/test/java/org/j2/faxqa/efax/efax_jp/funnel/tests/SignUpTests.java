...
public class SignUpTests extends BaseTest {
	...
	@TestRail(id = "C7862")
	@Test(enabled = true, groups = { "smoke" }, priority = 1, description = "US > SignUp for a new user account")
	public void verifyNewUserSignUpLogin(ITestContext context) throws Exception {
		...
		String content = new CommonMethods().getWelcomeEmail(email, "eFax Plus へようこそ！[eFax]", 60);
		logger.info(content);

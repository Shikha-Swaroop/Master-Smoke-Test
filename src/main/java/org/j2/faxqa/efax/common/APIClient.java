...
public class APIClient {
	private String m_user = System.getProperty("testrailUser");
	private String m_password = System.getProperty("testrailpassword");
	 ...
	 */
	public Object sendGet(String uri, String data) throws MalformedURLException, IOException, APIException, KeyManagementException, Exception {
		return this.sendRequest("GET", uri, data);
	}

	public Object sendGet(String uri) throws MalformedURLException, IOException, APIException, Exception, NoSuchAlgorithmException {
	 ...
	 * @throws KeyManagementException 
	 */
	public Object sendPost(String uri, Object data) throws MalformedURLException, IOException, APIException, KeyManagementException, Exception {
		return this.sendRequest("POST", uri, data);
	}

	private Object sendRequest(String method, String uri, Object data) throws MalformedURLException, IOException, APIException, NoSuchAlgorithmException, KeyManagementException
	{
